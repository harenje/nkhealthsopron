  ...
  return (
    <div className="flex flex-col basis-1/2 pb-10 relative">
       ...
       <Image
        ...
        ></Image>
        <div className="mt-1"><Button onClick={infoToggleHandler}>Személyes leírás</Button></div>
        
      <div
        className={`bg-nk-grey rounded-xl cursor-default ${
          infoToggler ? "opacity-80 transition-all duration-300 delay-100" : "opacity-0 transition-all duration-300 delay-100"
        } absolute top-1 left-2 right-2 p-0.5 flex flex-col gap-1 transition-all`}
      >
        {props.description}
      </div>
