...
function html(params: { url: string; host: string }) {
  ...
  const registeredParams = new URLSearchParams(url.split("?")[1]);
  const registeredUser = registeredParams.get("email");
...
<body class="dark-bg-gray-800" style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased;">
  <div style="display: none">
    Bejelentkezés a linkre kattintva elérhető.
      ...
      <tr>
        <td align="center">
          ...
          <div style="max-height: 40px">
            <div class="dark-bg-gray-800" style="height: 300px; background-color: #DEE2E9"></div>
          </div>
          <!--[if mso]>
            </v:textbox>
          </v:rect>
          <![endif]-->
          <table class="sm-w-full bg-[#171717]" style="position: relative; max-height: 0; width: 568px; opacity: 0.999" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td style="vertical-align: top" valign="top">
                <div class="sm-px-6">
                    ...
                    <tr>
                      <td class="sm-px-6" style="padding-left: 40px; padding-right: 40px">
                        <table style="width: 100%" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                            <td>
                              <a href="https://www.nksport.hu/" class="dark-text-gray-50" style="text-decoration: none; font-weight: 700; color: #191847">
                                NK Health & Sport Stúdió
                              </a>
                            </td>
                          </tr>
                        </table>
                  ...
                  <table class="dark-bg-gray-800" style="width: 100%; border-radius: 8px; background-color: #fff; box-shadow: 0px 10px 10px -5px rgba(0, 0, 0, 0.04), 0px 20px 25px -5px rgba(0, 0, 0, 0.1)" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                          ...
                          <tr>
                            <td>
                              <h1 class="dark-text-gray-50" style="margin: 0; font-size: 36px; font-weight: 700; line-height: 1; letter-spacing: -0.025em; color: #191847">
                                Bejelentkezés a linken keresztül.
                              </h1>
                              ...
                              <p class="dark-text-gray-50" style="margin: 0; font-size: 16px; line-height: 26px; color: #191847">
                                ...
                                <br>
                                <br>
                                Ezzel a bejelentkezési linkkel könnyen hozzáférést kaphatsz az adataidhoz az oldalunkon. Használatával nem kell újabb jelszót megjegyezned.
                              </p>
                            </td>
                          </tr>
                          <tr role="separator">
                          ...
                          <tr>
                            <td>
                              ...
                              <p style="margin: 0; font-size: 16px">
                                <span style="font-weight: 700">Vagy másold be az alábbi linket a böngésződbe: </span>
                                <br>
                ...
                <table class="sm-w-full" style="font-size: 12px; line-height: 16px" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="sm-block sm-w-full">
                      <a href="https://www.facebook.com/nkhealthsportstudio/" class="sm-py-3 hover-text-slate-600 dark-text-gray-200 dark-hover-text-gray-100" style="text-decoration: none; display: block; font-weight: 700; color: #767E9D">
                        Facebook
                      </a>
                    </td>
                    ...
                    <td class="sm-block sm-w-full">
                      <a href="https://www.instagram.com/nk_healthandsport_studio/" class="sm-py-3 hover-text-slate-600 dark-text-gray-200 dark-hover-text-gray-100" style="text-decoration: none; display: block; font-weight: 700; color: #767E9D">
                        Instagram
                      </a>
                    </td>
                  </tr>
